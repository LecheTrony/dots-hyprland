...
Singleton {
    ...
    property string sidePanelAnime: FileUtils.trimFileProtocol(`${Directories.booruDownloads}/sidepanel-anime.png`)
    ...
    property string mpvpaperThumbnails: FileUtils.trimFileProtocol(`${Directories.config}/hypr/custom/scripts/mpvpaper_thumbnails`)
