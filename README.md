...
Fork personal de [end-4/dots-hyprland](https://github.com/end-4/dots-hyprland) adaptado y configurado para **Artix Linux** (runit).
...
- La rama de actualizaciones sin modificar se puede traer con `git fetch upstream` + rebase.
